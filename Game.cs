...
namespace FORMSDENEME2
{
    public class Game
    {
        ...
        public int score;
        public Image flag = Image.FromFile("C:\\Users\\Asus\\Desktop\\Proje1\\MINESWEEPERGAME\\FORMSDENEME2\\Resources\\flag.png");
        public Image mine = Image.FromFile("C:\\Users\\Asus\\Desktop\\Proje1\\MINESWEEPERGAME\\FORMSDENEME2\\Resources\\mine.png");
        ...
        public void CreateGrid(Form form, int rows, int cols)
        {
            ...
            for (int i = 0; i < rows; i++)
            {
                for (int j = 0; j < cols; j++)
                {
                    ...
                    cell.MouseDown += form2.Cells_MouseDown;
