                    ...
                    if (e.Button == MouseButtons.Left)
                    {
                        if (!game.youWon)
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    for (int j = clickedCol - 1; j <= clickedCol + 1; j++)
                                    {
                                        if (i >= 0 && i < game.gridSize && j >= 0 && j < game.gridSize)
                                        {
                                            if (game.Cells[i, j].Tag != null && game.Cells[i, j].Tag.ToString() == "X")
                                            {
                                                mineCount++;
                                            }
                                        }
                                ...
                                if (mineCount > 0)
                                {
                                    clickedCell.Text = mineCount.ToString();
                                    clickedCell.Font = new Font(clickedCell.Font, FontStyle.Bold);
                                }
